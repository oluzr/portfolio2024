...
const keywordsContents = [
  ...
  },
  {
    ...
    content:
      `웹퍼블리셔로 근무하며 자연스럽게 프론트엔드 개발로의 영역 확장을 꿈꾸게 되어 공부를 시작했습니다.
      공부한 내용을 바탕으로 동기들과 사이드 프로젝트를 성공적으로 마쳤고, 짧지만 실제 회사에서 진행했던
      다양한 프로젝트를 통해 빠른 상황 판단력과 협업 능력을 키울 수 있었습니다. 🫡`,
  },
  {
    title: "Array.from('취미')",
    content: `'Depressed? Go to the gym! 💪🏻🏋🏻‍♀️' 
    건강한 몸과 마음을 위해 매일 헬스에 다니며 꾸준히 운동하고 있습니다. 가끔은 지인들과 등산이나 클라이밍도 즐기며 에너지를 충전하곤 해요. 요즘엔 피아노에도 푹 빠져서 학원에서 레슨을 받으며 열심히 연습하고 있답니다. 🎹🎼 `,
  },
  {
