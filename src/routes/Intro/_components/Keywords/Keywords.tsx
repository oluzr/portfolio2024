...
const keywordsContents = [
  ...
  },
  {
    ...
    content: `웹퍼블리셔로 근무하며 자연스럽게 프론트엔드 개발로의 영역 확장을 꿈꾸게 되어 공부를 시작했습니다.
  ...
  },
  {
    ...
    건강한 몸과 마음을 위해 매일 헬스에 다니며 꾸준히 운동하고 있습니다. 가끔은 지인들과 등산이나 클라이밍도 즐기며 에너지를 충전하곤 해요. 요즘엔 피아노에 푹 빠져서 틈틈히 열심히 연습하고 있답니다. 🎹🎼 `,
  },
  {
