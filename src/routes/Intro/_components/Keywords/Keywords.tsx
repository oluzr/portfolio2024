...
const keywordsContents = [
  {
    ...
    content:
      "낯선 것은 내가 못하는 것이 아니라 앞으로 새로 알게되는 것이다, 라는 마음가짐으로 낯선 것이 익숙해질 때까지 익힙니다. 많은 시행착오와 연습이 빠른 상황판단을 가능케 하고 이것이 유능한 개발자로 나아가는 길이라 생각합니다",
  },
  {
  ...
  },
  {
    title: "Array.from('취미')",
    content:
      `'Depressed? Go to the gym!' 건강한 몸과 정신을 위해 매일 헬스를 가고 종종 지인들과 등산, 클라이밍도 즐겨 합니다 😋 
      또한 운동 뿐 아니라 피아노도 즐겨 칩니다 🎼🎹`,
  },
  {
